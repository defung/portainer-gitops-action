...
const toActionType = (str: string): ActionType | undefined => Object.values(ActionType).find((a) => a.valueOf() === str);
...
const props = {
  getRequired: <O>(propName: string, validate: (str: string) => O | undefined): O => {
  ...
  getRequiredStr: (propName: string): string => props.getRequired<string>(propName, (str: string) => str),
  getRequiredByAction: <O>(propName: string, currentAction: ActionType, requiredFor: ActionType[], validate: (str: string) => O | undefined): O | undefined => {
  ...
  getRequiredByActionStr: (propName: string, currentAction: ActionType, requiredFor: ActionType[]): string | undefined => props.getRequiredByAction<string>(propName, currentAction, requiredFor, (str: string) => str),
};
